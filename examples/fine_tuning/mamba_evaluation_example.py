# Example: Advanced evaluation for a fine-tuned Mamba model (perplexity & accuracy)
# Requires: pip install transformers mamba-ssm torch peft
# See: https://huggingface.co/state-spaces/mamba-130m
...
ADAPTER_PATH = "./mamba_lora_adapter"  # Path to LoRA adapter (if used)
...
val_texts = [
    ...
    "LoRA enables efficient fine-tuning of Mamba.",
    "PEFT is compatible with Mamba models.",
    "PyTorch and HuggingFace make it easy to use Mamba."
]
