# Example: Hyperparameter search for RWKV PEFT/adapter fine-tuning using Optuna
...
model = DummyRWKVModel(hidden_size=64)
...
texts = [
    ...
    "RWKV models can be adapted with small modules.",
