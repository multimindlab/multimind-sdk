...
class TraceLogger:
    ...
    def start_trace(
        self, trace_id: str, operation: str, metadata: Optional[Dict[str, Any]] = None
    ) -> None:
        """Start a new trace."""
        trace = {
            "trace_id": trace_id,
    ...
    def add_event(
        self, trace_id: str, event_type: str, data: Dict[str, Any], level: str = "info"
    ) -> None:
    ...
    def end_trace(
        ...
        self.logger.info(f"Ended trace {trace_id} with status {status}")
    ...
    def list_traces(
        self, operation: Optional[str] = None, status: Optional[str] = None
    ) -> List[Dict[str, Any]]:
