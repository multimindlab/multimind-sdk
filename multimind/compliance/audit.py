...
class ComplianceAuditLogger(BaseModel):
    ...
    async def get_user_activity(
        ...
        return await self.get_events(user_id=user_id, start_time=start_time, end_time=end_time)
    ...
    async def get_system_activity(
        ...
        return await self.get_events(system_id=system_id, start_time=start_time, end_time=end_time)
    ...
    async def get_data_access(
        ...
        return await self.get_events(data_id=data_id, start_time=start_time, end_time=end_time)
