...
audit trail to LangChain, LlamaIndex, CrewAI, and raw OpenAI clients — no
migration required. Everything resolves lazily via PEP 562, so importing
this package never requires any of those frameworks; a missing framework
raises a friendly ImportError only when its adapter is actually used.
"""
