...
class PGVectorBackend(VectorStoreBackend):
    def __init__(
        ...
        **kwargs,
        ...
        self.host = host or os.environ.get("PGVECTOR_HOST", "localhost")
        self.port = port or int(os.environ.get("PGVECTOR_PORT", 5432))
        self.user = user or os.environ.get("PGVECTOR_USER", "postgres")
        self.password = password or os.environ.get("PGVECTOR_PASSWORD", "")
