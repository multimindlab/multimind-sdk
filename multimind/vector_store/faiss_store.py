...
class FAISSVectorStore(VectorStore):
    ...
    def __init__(self, config: VectorStoreConfig):
        ...
        if config.index_type == "flat":
            ...
            self.index = faiss.IndexIVFFlat(
                faiss.IndexFlatL2(self.dimension), self.dimension, nlist
            )
    ...
    async def add_vectors(
        self, vectors: List[np.ndarray], metadata: List[Dict[str, Any]], **kwargs
    ) -> List[str]:
    ...
    async def search(self, query_vector: np.ndarray, k: int = 5, **kwargs) -> List[Dict[str, Any]]:
    ...
    async def delete_vectors(self, vector_ids: List[str], **kwargs) -> bool:
    ...
    async def get_vector(self, vector_id: str, **kwargs) -> Optional[Dict[str, Any]]:
        """Get a vector by ID."""
        ...
        return {"vector_id": vector_id, "metadata": self.metadata_store[vector_id]}

    async def update_metadata(self, vector_id: str, metadata: Dict[str, Any], **kwargs) -> bool:
