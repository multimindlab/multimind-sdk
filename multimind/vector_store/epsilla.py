...
class EpsillaBackend(VectorStoreBackend):
    ...
    async def add_vectors(self, vectors, metadatas, documents, ids=None):
        raise NotImplementedError(
            "EpsillaBackend.add_vectors is not implemented: the Epsilla backend is a "
    ...
    async def search(
        ...
        raise NotImplementedError(
            "EpsillaBackend.search is not implemented: the Epsilla backend is a stub. "
    ...
    async def delete_vectors(self, ids):
        raise NotImplementedError(
            "EpsillaBackend.delete_vectors is not implemented: the Epsilla backend is "
    ...
    async def clear(self):
        raise NotImplementedError(
            "EpsillaBackend.clear is not implemented: the Epsilla backend is a stub. "
            "Use an implemented backend such as FAISS, Chroma, Qdrant, Pinecone, "
            "Milvus, or Weaviate."
        )
    ...
    async def persist(self, path):
        raise NotImplementedError(
            "EpsillaBackend.persist is not implemented: the Epsilla backend is a "
            "stub. Use an implemented backend such as FAISS, Chroma, Qdrant, "
            "Pinecone, Milvus, or Weaviate."
        )
    ...
    def add(self, vector, metadata=None):
        raise NotImplementedError(
            "EpsillaBackend.add is not implemented: the Epsilla backend is a stub. "
            "Use an implemented backend such as FAISS, Chroma, Qdrant, Pinecone, "
            "Milvus, or Weaviate."
        )
    ...
    def search(self, *args, **kwargs):
        raise NotImplementedError(
            "EpsillaBackend.search is a placeholder. Integrate with Epsilla SDK."
        )

    def delete(self, *args, **kwargs):
        raise NotImplementedError(
            "EpsillaBackend.delete is a placeholder. Integrate with Epsilla SDK."
        )
