...
class PGVectoRSBackend(VectorStoreBackend):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.host = host or os.environ.get("PGVECTORS_HOST", "localhost")
        self.port = port or int(os.environ.get("PGVECTORS_PORT", 5432))
        self.user = user or os.environ.get("PGVECTORS_USER", "postgres")
        self.password = password or os.environ.get("PGVECTORS_PASSWORD", "")
