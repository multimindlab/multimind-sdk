...
class VectorStoreType(Enum):
    ...
    def get_search_engine_backends(cls) -> Set["VectorStoreType"]:
        ...
        return {
            cls.ELASTICSEARCH,
            cls.ELASTIC_VECTOR_SEARCH,
            cls.OPENSEARCH_VECTOR_SEARCH,
            cls.ALIBABACLOUD_OPENSEARCH,
        }
...
class VectorStoreConfig:
    ...
    def __init__(
        self, connection_params: Dict[str, Any], store_type: Optional[VectorStoreType] = None
    ):
        """
    ...
    def create_faiss_config(
        cls, dimension: int, metric: str = "cosine", **kwargs
    ) -> "VectorStoreConfig":
    ...
    def create_chroma_config(
        cls, persist_directory: str, collection_name: str = "default", **kwargs
    ) -> "VectorStoreConfig":
    ...
    def create_pinecone_config(
        cls, api_key: str, environment: str, index_name: str, **kwargs
    ) -> "VectorStoreConfig":
    ...
    def create_weaviate_config(cls, url: str, **kwargs) -> "VectorStoreConfig":
        ...
        config = {"store_type": VectorStoreType.WEAVIATE.value, "url": url, **kwargs}
        return cls(config, VectorStoreType.WEAVIATE)

    @classmethod
    def create_pgvector_config(
        cls, host: str, port: int, database: str, user: str, password: str, **kwargs
    ) -> "VectorStoreConfig":
...
class VectorStoreBackend(abc.ABC):
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        """
        return {"backend_type": self.__class__.__name__, "config": self.config.to_dict()}
