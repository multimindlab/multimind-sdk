...
try:
    ...
    logger.warning(
        "transformers not available. Advanced document processing features will be disabled."
    )
...
class AdvancedDocumentProcessor:
    ...
    async def process_document(
        ...
        text_chunks = await self._process_text_content(
            document=document, structure=structure, **kwargs
        )
        chunks.extend(text_chunks)

        # Process tables
        table_chunks = await self._process_tables(document=document, structure=structure, **kwargs)
        chunks.extend(table_chunks)

        # Process images
        image_chunks = await self._process_images(document=document, structure=structure, **kwargs)
        chunks.extend(image_chunks)

        return structure, chunks

    async def _analyze_structure(self, document: Dict[str, Any], **kwargs) -> DocumentStructure:
        """Analyze document structure."""
        # Extract sections
    ...
    async def _extract_sections(self, document: Dict[str, Any], **kwargs) -> List[Dict[str, Any]]:
    ...
    async def _identify_headers(self, document: Dict[str, Any], **kwargs) -> List[Dict[str, Any]]:
    ...
    async def _extract_paragraphs(self, document: Dict[str, Any], **kwargs) -> List[Dict[str, Any]]:
    ...
    async def _identify_lists(self, document: Dict[str, Any], **kwargs) -> List[Dict[str, Any]]:
    ...
    async def _process_text_content(
        self, document: Dict[str, Any], structure: DocumentStructure, **kwargs
    ) -> List[Dict[str, Any]]:
            ...
            chunks.append(
                {
                    ...
                    "metadata": {"position": para["position"], "context": para["context"]},
                }
            )
