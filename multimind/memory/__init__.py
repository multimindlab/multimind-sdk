...
_LAZY_ATTRS: dict[str, tuple[str, str | None]] = {
    ...
    "AutobiographicalMemory": ("multimind.memory.autobiographical", "memory"),
    "BayesianMemory": ("multimind.memory.bayesian", "finetune"),
    "BufferWindowMemory": ("multimind.memory.buffer_window", None),
    "CausalMemory": ("multimind.memory.causal", "memory"),
    ...
    "ConsensusMemory": ("multimind.memory.consensus", None),
    ...
    "GenerativeMemory": ("multimind.memory.generative", None),
    "HierarchicalMemory": ("multimind.memory.hierarchical", None),
    "HTMMemory": ("multimind.memory.htm", "memory"),
    "HybridMemory": ("multimind.memory.hybrid", "memory"),
    "ImplicitMemory": ("multimind.memory.implicit", "memory"),
    "KnowledgeGraphMemory": ("multimind.memory.knowledge_graph", "memory"),
    "MetaMemory": ("multimind.memory.meta", None),
    "NeuroSymbolicMemory": ("multimind.memory.neuro_symbolic", "memory"),
    ...
    "ProspectiveMemory": ("multimind.memory.prospective", "memory"),
    ...
    "ReinforcementMemory": ("multimind.memory.reinforcement", None),
    ...
    "SketchMemory": ("multimind.memory.sketch", "memory"),
