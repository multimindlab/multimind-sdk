...
class ImportanceScorer:
    ...
    async def score(
        ...
        adjusted_weights = self._adjust_weights_by_confidence(
            semantic_confidence, recency_confidence, task_confidence
        )
    ...
    async def _calculate_semantic_score(
        self, content: str, context: Optional[List[Dict[str, Any]]] = None
    ) -> float:
    ...
    async def _calculate_task_score(self, content: str, task_type: Optional[str]) -> float:
    ...
    async def _calculate_confidence(self, component: str, content: str) -> float:
    ...
    async def _update_weights(self, score_data: Dict[str, Any]) -> None:
        ...
        semantic_performance = (
            score_data["scores"]["semantic"] * score_data["confidence"]["semantic"]
        )
        ...
        semantic_adjustment = (
            semantic_performance / total_performance - self.semantic_weight
        ) * self.learning_rate
        recency_adjustment = (
            recency_performance / total_performance - self.recency_weight
        ) * self.learning_rate
        task_adjustment = (
            task_performance / total_performance - self.task_weight
        ) * self.learning_rate
