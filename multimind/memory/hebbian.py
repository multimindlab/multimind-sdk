...
class FastWeightMemory(BaseMemory):
    ...
    async def add_memory(
        ...
        self.weights[slot_idx] = (1 - self.decay_rate) * self.weights[
            slot_idx
    ...
    async def get_memory(self, memory_id: str) -> Optional[Dict[str, Any]]:
        ...
        self.avg_similarity = (
            self.avg_similarity * (self.total_retrievals - 1) + max_similarity
    ...
    async def update_memory(self, memory_id: str, updates: Dict[str, Any]) -> None:
        ...
        if "content" in updates:
            ...
            # Update weights
            self.weights[max_sim_idx] = (1 - self.decay_rate) * self.weights[
                max_sim_idx
