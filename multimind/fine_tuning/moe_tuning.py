...
class MoETrainer:
    ...
    def __init__(
        ...
        # Initialize metrics
        self.metrics = {"train_loss": [], "aux_loss": [], "expert_usage": []}
    ...
    def train_step(
        self, batch: torch.Tensor, labels: torch.Tensor, task_loss_fn: nn.Module
    ) -> Dict[str, float]:
        """
        ...
        # Combine losses
        total_loss = (
            task_loss + self.aux_loss_weight * aux_loss + self.expert_balance_weight * balance_loss
        )
    ...
    def train_epoch(
        self, train_loader: DataLoader, task_loss_fn: nn.Module, epoch: int
    ) -> Dict[str, float]:
        """
        Train for one epoch.
        ...
        """
        epoch_metrics = {"task_loss": [], "aux_loss": [], "balance_loss": [], "total_loss": []}
    ...
    def train(
        ...
        training_metrics = {"train_loss": [], "eval_loss": [] if eval_loader else None}
    ...
    def evaluate(self, eval_loader: DataLoader, loss_fn: nn.Module) -> Dict[str, float]:
        """
        Evaluate the model.
