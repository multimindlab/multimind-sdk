...
class WorkflowRegistry:
    ...
    @classmethod
    def register(
        cls, workflow_class: Type[MCPWorkflowAPI], metadata: Optional[Dict[str, Any]] = None
    ) -> Type[MCPWorkflowAPI]:
        """
    ...
    def create_workflow(
        ...
        **kwargs,
        ...
        return workflow_class.create_workflow(models=models, integrations=integrations, **kwargs)
    ...
    def list_workflows(cls) -> List[Dict[str, Any]]:
        ...
        """
        return [
            {"name": name, **metadata["info"], "metadata": metadata["metadata"]}
    ...
    @classmethod
    def update_workflow_metadata(cls, name: str, metadata: Dict[str, Any]) -> None:
        """
