...
class MCPWorkflowAPI:
    ...
    async def execute(
        self, initial_context: Dict[str, Any], callbacks: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
        ...
        return await self.executor.execute(
            spec=workflow_spec, initial_context=initial_context, callbacks=callbacks
        )

    def _build_workflow_spec(self) -> Dict[str, Any]:
        """Build the workflow specification. Must be implemented in subclass."""
        raise NotImplementedError(
            "_build_workflow_spec must be implemented in a subclass of MCPWorkflowAPI."
        )

    def _validate_context(self, context: Dict[str, Any]) -> bool:
        """Validate the workflow context. Must be implemented in subclass."""
        raise NotImplementedError(
            "_validate_context must be implemented in a subclass of MCPWorkflowAPI."
        )
    ...
    def _get_required_integrations(cls) -> List[str]:
        ...
        raise NotImplementedError(
            "_get_required_integrations must be implemented in a subclass of MCPWorkflowAPI."
        )
    ...
    def _get_required_models(cls) -> List[str]:
        ...
        raise NotImplementedError(
            "_get_required_models must be implemented in a subclass of MCPWorkflowAPI."
        )
    ...
    @classmethod
    def create_workflow(
        cls, models: Dict[str, BaseLLM], integrations: Dict[str, IntegrationHandler], **kwargs
    ) -> "MCPWorkflowAPI":
        """
